...
class Candidate(NodeBase):
    ...
    def start_election_timer(self):
        ...
        self.election_timer = Timer(interval, self.start_election, self.state.server_info.id, "candidate")
    ...
    def start_election(self):
        ...
        print(f"Called start_election (server_info) in RAFT_NODE: {server_tostring(self.state.server_info)}")
        ...
        for id, peer in self.state.peer_map.items():
            ...
            request = RequestVote(server_id=self.state.server_info.id,
                                  term=next_term,
